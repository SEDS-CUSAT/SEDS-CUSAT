...
!function (a, b) {
        ...
        if (11 !== k && (f = _.exec(a))) {
          if (j = f[1]) {
            if (9 === k) {
              ...
              b.ownerDocument && (h = b.ownerDocument.getElementById(j)) &&
              t(b, h) && h.id === j
            ) return d.push(h), d;
          } else {
        ...
        if (e > 1) {
          for (
            ...
            c[b] && n.isFunction(c[b].promise)
              ? c[b].promise().done(h(b, k, c)).fail(g.reject).progress(
                h(b, j, i),
              )
              : --f;
          }
      ...
      filter: function (a, b) {
        ...
        return null == a.pageX && null != b.clientX &&
          (c = a.target.ownerDocument || l,
            ...
            a.pageY = b.clientY + (d && d.scrollTop || e && e.scrollTop || 0) -
  ...
  n.extend({
    clone: function (a, b, c) {
      ...
      if (
        !(k.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType ||
          n.isXMLDoc(a))
      ) {
        ...
        if (
          ...
          if (g) {
            for (
              ...
              h = f[j],
                fb.test(h.type || "") && !L.access(h, "globalEval") &&
    ...
    ajax: function (a, b) {
      ...
      if (
        o.promise(v).complete = p.add,
          v.success = v.done,
          v.error = v.fail,
          k.url = ((a || k.url || oc) + "").replace(ec, "").replace(
            jc,
            pc[1] + "//",
          ),
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          return this.name && !n(this).is(":disabled") &&
            zc.test(this.nodeName) && !yc.test(a) &&
  ...
  n.ajaxSetup({
    ...
    n.ajaxPrefilter("json jsonp", function (b, c, d) {
      var e,
        ...
        g,
        h = b.jsonp !== !1 &&
          (Gc.test(b.url) ? "url" : "string" == typeof b.data &&
      ...
      return h || "jsonp" === b.dataTypes[0]
        ? (e = b.jsonpCallback = n.isFunction(b.jsonpCallback)
          ? b.jsonpCallback()
          : b.jsonpCallback,
          h ? b[h] = b[h].replace(Gc, "$1" + e) : b.jsonp !== !1 &&
